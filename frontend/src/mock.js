  ...
  howIThink: {
    ...
    principles: [
      ...
      },
      {
        ...
        subsections: [
          {
            heading: "How I write epics",
            content: "I write epics as customer-deliverable capabilities — end-to-end, sprint-sized, and shippable to a user the moment they're complete. Each epic covers the full product flow, not just a layer of it. It's capability-oriented, not feature-oriented."
          },
          {
            heading: "How I write user stories",
            content: "User stories go one level deeper — each one is a vertical slice covering all functional impact areas needed to implement that behaviour end to end. A well-written story is independently testable by QA without waiting for other stories to be done."
          },
          {
            heading: "Before production — PO acceptance checklist",
            content: "Before any epic reaches production, I run a PO acceptance checklist — an end-to-end capability test that validates the full flow meets production readiness criteria, not just individual story completion."
          },
          {
            heading: "After delivery — release notes and documentation",
            content: "Once an epic ships, I write release notes for all features in it and update the product help documentation and FAQ — so the latest capability is always reflected in what users and support teams can reference."
          }
        ],
        closingStatement: "Every sprint delivers working product, documented, verified, and ready to use."
      },
      {
        number: "06",
